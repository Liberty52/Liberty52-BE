package com.liberty52.main.global.adapter.papago;

import com.liberty52.main.global.constants.TranslationConstants;
import com.liberty52.main.global.exception.internal.PapagoApiException;
...
public class PapagoApiClient {
    ...
    public TranslationDto.Response postTranslation(TranslationConstants.LangCode source, TranslationConstants.LangCode target, String text) throws PapagoApiException.TooLongTextForTranslationException, PapagoApiException.TranslationSameSourceTargetException {
    ...
    public static class TranslationDto {
        public static final class Request extends MultiValueMapAdapter<String, String> {
            public Request(TranslationConstants.LangCode source, TranslationConstants.LangCode target, String text) throws PapagoApiException.TranslationSameSourceTargetException, PapagoApiException.TooLongTextForTranslationException {
                super(new HashMap<>());
                if (target == source) throw new PapagoApiException.TranslationSameSourceTargetException();
                if (text.length() > 1000) throw new PapagoApiException.TooLongTextForTranslationException();
