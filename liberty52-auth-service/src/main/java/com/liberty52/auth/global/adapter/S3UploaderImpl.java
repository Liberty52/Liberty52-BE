...
import com.liberty52.auth.global.exception.external.badrequest.FileTypeIsNotImageException;
import com.liberty52.auth.global.exception.external.internalservererror.FileConvertException;
import com.liberty52.auth.global.exception.external.internalservererror.FileNullException;
import com.liberty52.auth.global.exception.external.internalservererror.S3UploaderException;
...
public class S3UploaderImpl implements S3Uploader {
    ...
    @Value("${my-storage.dir.user.profile}")
    private String path;
