...
public class CartItemRetriveServiceTest {
    ...
    void 장바구니조회(){
        ...
        Assertions.assertEquals(cartItemResponse1.getName(), "Liberty52");
        Assertions.assertEquals(cartItemResponse1.getImageUrl(), "");
        Assertions.assertEquals(cartItemResponse1.getPrice(), 1000000);
        ...
        Assertions.assertEquals(cartItemResponse2.getName(), "Liberty52");
        Assertions.assertEquals(cartItemResponse2.getImageUrl(), "");
        Assertions.assertEquals(cartItemResponse2.getPrice(), 1000000);
        ...
        Assertions.assertThrows(NotFoundAuthIdException.class, ()->cartItemRetriveService.retriveCartItem("bbb"));

        Assertions.assertThrows(NotFoundCartProductException.class, ()->cartItemRetriveService.retriveCartItem("ccc"));
    }
}
