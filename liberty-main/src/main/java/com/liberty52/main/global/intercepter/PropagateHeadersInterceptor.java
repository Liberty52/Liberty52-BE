package com.liberty52.main.global.intercepter;
 ...
 * Info: <a href="https://istio.io/docs/tasks/telemetry/distributed-tracing/overview/">...</a>
 * <a href="https://istio.io/faq/distributed-tracing/#istio-copy-headers">...</a> (Why can't Istio Propagate headers instead of the application?)
 */
@Component
