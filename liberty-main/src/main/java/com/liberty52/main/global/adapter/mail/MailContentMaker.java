...
import com.liberty52.main.global.adapter.mail.content.OrderCanceledMail;
import com.liberty52.main.global.adapter.mail.content.OrderedCompletedMail;
import com.liberty52.main.global.adapter.mail.content.OrderedProductInfoSection;
import com.liberty52.main.global.adapter.mail.content.RequestDepositMail;
import com.liberty52.main.global.constants.ProductConstants;
import com.liberty52.main.global.constants.RepresentImageUrl;
...
public class MailContentMaker {
    ...
    public static String makeCardOrderedCompletedContent(Orders order) {
        ...
        // 결제정보
        CardPayment.CardPaymentInfo paymentInfo = order.getPayment().getInfoAsDto();
